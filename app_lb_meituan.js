            ...
            try {
                ...
                allMessage += '\n脚本状态' + data.msg1;
                    ...
                    for (let k = 0; k < slckArr.length; k++) {
                        $.message = ""
                        mtToken = slckArr[k]
                        mtToken = mtToken.replace(/token=/g,'')
                        $.index = k + 1;
                         if(meituanyq==''){
                            inviteCode=`NnOIp-QOs8SiYF1dcSlL5qPImZ5kbRzbxImo5D_L2tlSa49fO2lYbsmvOgY4wlCRP_govsBovb22kOaBsjan5wO993EC1CIjfAml9eKKq5hoiFfH6cRaiCY-9lnfddOZ`
                        }else{
                            if(k==0){
                                inviteCode=`NnOIp-QOs8SiYF1dcSlL5qPImZ5kbRzbxImo5D_L2tlSa49fO2lYbsmvOgY4wlCRP_govsBovb22kOaBsjan55XA0EDgAxDh6rxMoATOI5_dSHBjAPiRM5OIt_pWKeMJ`
                            }else{
